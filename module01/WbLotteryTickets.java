...
public class WbLotteryTickets {
  public static void main(String[] args) {
    int[] ticket = { 34, 43, 45, 65, 21, 54 };
    int[] ticket2;
    // Task 1 - Copy the elements of ticket into ticket2, but change the third value
    // to 54.
   ...
   *               2. print a new line
   */
  private static void printTicketNumbers(int[] ticket) {
