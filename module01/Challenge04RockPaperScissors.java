...
public class Challenge04RockPaperScissors {
   ...
   */
  private static String computerChooses() {
    String choice = "";
    int randomInt0to2 = (int) (Math.random() * 2);
   ...
   *                       – prints: <result>
   */
  private static void printResult(String yourChoice, String computerChoice, String result) {
    System.out.println();
